...
- Select and automatically connect to a local network time protocol (NTP) server to keep accurate time.
...
Any calls to WiFiManager methods should be done after the call to WiFiTimeManager::**Init()** except as noted above..
...
Global variables use 67100 bytes (20%) of dynamic memory, leaving 260580 bytes for 
